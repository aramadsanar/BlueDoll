...
public class SQLiteDatabaseHelper  extends SQLiteOpenHelper {
    private static final String DBNAME = "BlueDoll";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_USER_TABLE = "CREATE TABLE " + USER_TABLE_NAME + "("
                + USER_TABLE_ID_COLUMN + " INTEGER PRIMARY KEY AUTOINCREMENT," + USER_TABLE_NAME+ " VARCHAR(255),"
    ...
    public User authenticateUser(User user) {
        ...
        if (cursor.moveToFirst()) {
            ...
            String foundName = cursor.getString(
                    cursor.getColumnIndexOrThrow(USER_TABLE_NAME)
            );
    ...
    public boolean registerUser(User user) {
        ...
        long rowId = database.insert(USER_TABLE_NAME, null, newUser);
    ...
    private void preloadDolls() {
        putDoll(new Doll(-1, "Boneka Kucing", "Boneka Kucing Lucu", R.drawable.boneka_kucing));
        putDoll(new Doll(-1, "Boneka Rusa", "Boneka Rusa Lucu", R.drawable.boneka_rusa));
        putDoll(new Doll(-1, "Boneka Panda", "Boneka Panda Lucu", R.drawable.boneka_panda));
        putDoll(new Doll(-1, "Boneka Babi", "Boneka Babi Lucu", R.drawable.boneka_babi));
    }
